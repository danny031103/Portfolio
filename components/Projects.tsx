const featured = {
  ...
  live: 'https://visionaquatics.vercel.app/',
...
const projects = [
  ...
  },
  {
    name: 'NYU Bus App',
    description:
      'Web app giving NYU students accurate real-time shuttle bus arrival and departure information in a clean, readable interface.',
    tags: ['Python', 'HTML', 'CSS', 'REST APIs'],
